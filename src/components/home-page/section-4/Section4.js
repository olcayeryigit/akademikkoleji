...
const Section4 = () => {
  ...
  return (
    <div className="relative py-12  bg-gradient-to-r from-gray-100 to-white">
      <div className='container mx-auto w-3/4'>
        <h1 className="text-3xl md:text-4xl font-extrabold leading-tight text-center mb-4 ">
          Akademik Koleji Öğrenci Kulüpleri  
        </h1>   
        <h2 className='text-center text-xl mb-8 font-normal'>Sosyal, Kültürel ve Akademik Gelişim İçin Kulüpler</h2>           
