...
const ExamCountdown = () => {
  ...
  return (
    ...
    <div className=" bg-gradient-to-b from-gray-100 via-gray-200 to-gray-400">
      ...
      <div className="container mx-auto w-full px-6 rounded-lg grid grid-cols-2">
      
    

      
<div className='relative top-0 left-0 col-span-1 h-[28rem]'>
...
<div className=''>
    ...
    <div className='flex items-center justify-center w-full bg-[#FB923C] p-4 '>
